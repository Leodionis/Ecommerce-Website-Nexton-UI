...
import styles from "./RegisterPageDesktop.module.css";
...
const RegisterPageDesktop = () => {
  ...
  return (
    <div className={styles.registerPageDesktop}>
      ...
      <div className={styles.main}>
        <div className={styles.mainContent}>
          <div className={styles.h5}>
            <div className={styles.h21}>Register</div>
          </div>
          <div className={styles.loginForm}>
            <div className={styles.form}>
              ...
              <div className={styles.emailInput}>
                <div className={styles.h5}>
                  <div className={styles.h51}>Password (Again)</div>
                </div>
                <input
                  className={styles.input1}
                  placeholder="enter password"
                  ...
                  <div className={styles.itemDetails}>
                    <div className={styles.details}>
                      ...
                      <div className={styles.price}>
                        ...
                        <div className={styles.pxRegular16}>
              ...
              <div className={styles.categories}>
                ...
                <div className={styles.categoryItems}>
                  <div className={styles.categoryItem}>
                    ...
                    <div className={styles.pxRegular19}>
